...
<h2 class="text-teal-800 p-5 text-center uppercase text-3xl font-bold">Edició de partits: <br></h2>
<form action="{{route('partits.update', $partits)}}" method="POST" class="max-w-3xl p-8 m-auto">
    ...
    <div class="flex justify-around">
        ...
        <a class="px-4 py-2 rounded-md bg-teal-500 text-sky-100 hover:bg-teal-800" href="{{route('partits.index')}}">Cancelar</a>
       </div>
</form>
