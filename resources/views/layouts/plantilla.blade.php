...
<body>
  <div class="flex flex-col h-screen min-h-screen">
    ...
    <nav class="flex items-center justify-between flex-wrap bg-teal-500 px-6">
      ...
      <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        <div class="text-sm lg:flex-grow">
          <a href="{{route('entitats.create_entitats')}}" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
            Entitats
          </a>
    ...
    <footer class=" text-sky-100 bg-teal-500" >
